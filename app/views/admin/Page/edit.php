                        ...
                        <?php foreach (\shop\App::$app::getProperty('languages') as $k => $lang): ?>
                            <div class="tab-pane fade <?php if ($lang['base']) echo 'active show' ?>" id="<?php echo $k ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_description[<?php echo $lang['id']; ?>][title]"
                                           class="form-control" id="title" placeholder="Name page"
                                           value="<?php echo $page[$lang['id']]['title']; ?>">
                                </div>

                                <div class="form-group">
                                    <label for="description">Meta description</label>
                                    <input type="text" name="page_description[<?php echo $lang['id']; ?>][description]"
                                           class="form-control" id="description" placeholder="Meta-description"
                                           value="<?php echo $page[$lang['id']]['description']; ?>">
                                </div>

                                <div class="form-group">
                                    <label for="keywords">Keywords</label>
                                    <input type="text" name="page_description[<?php echo $lang['id']; ?>][keywords]"
                                           class="form-control" id="keywords" placeholder="Keywords"
                                           value="<?php echo $page[$lang['id']]['keywords']; ?>">
                                </div>

                                <div class="form-group">
                                    <label for="content">Content</label>
                                    <textarea name="page_description[<?php echo $lang['id'] ?>][content]"
                                              class="form-control editor" id="content" rows="3"
                                              placeholder="Content page"><?php echo ($page[$lang['id']]['content']) ?></textarea>
                                </div>
