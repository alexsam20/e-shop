...
<table style="border: 1px solid #ddd; border-collapse: collapse; width: 100%;">
    ...
    <?php foreach($_SESSION['cart'] as $item): ?>
        <tr>
            <td style="padding: 8px; border: 1px solid #ddd;"><?php echo $item['title'] ?></td>
            <td style="padding: 8px; border: 1px solid #ddd;"><?php echo $item['qty'] ?></td>
            <td style="padding: 8px; border: 1px solid #ddd;"><?php echo $item['price'] ?></td>
            <td style="padding: 8px; border: 1px solid #ddd;"><?php echo $item['price'] * $item['qty'] ?></td>
        </tr>
    <?php endforeach;?>
    <tr>
        <td colspan="3" style="padding: 8px; border: 1px solid #ddd;"><?php __('tpl_cart_total_qty'); ?></td>
        <td style="padding: 8px; border: 1px solid #ddd;"><?php echo $_SESSION['cart.qty'] ?></td>
    </tr>
    <tr>
        <td colspan="3" style="padding: 8px; border: 1px solid #ddd;"><?php __('tpl_cart_sum'); ?></td>
        <td style="padding: 8px; border: 1px solid #ddd;">$<?php echo $_SESSION['cart.sum'] ?></td>
    </tr>
    </tbody>
</table>
